    ...
    const nfse = existingId
      ? await this.prisma.nfseDocumento.update({
          ...
          data: {
            ...
            valorDescontoIncondicionado: this.toDecimal(parsed.valorDescontoIncondicionado),
            valorDescontoCondicionado: this.toDecimal(parsed.valorDescontoCondicionado),
      ...
      try {
        ...
        await this.prisma.nfseDocumento.update({
          ...
          data: {
            ...
            valorDescontoIncondicionado: this.toDecimal(parsed.valorDescontoIncondicionado) ?? doc.valorDescontoIncondicionado,
            valorDescontoCondicionado: this.toDecimal(parsed.valorDescontoCondicionado) ?? doc.valorDescontoCondicionado,
  ...
  private extractMunicipioTomadorFromXml(xml: string): string | null {
    const codigoMunicipio =
      this.extractXmlPathValue(xml, [
        ...
        ['TomadorServico', 'Municipio'],
        ['TomadorServico', 'MunicipioNome'],
        ['TomadorServico', 'Cidade'],
        ['TomadorServico', 'xMun'],
        ['TomadorServico', 'xMunicipio'],
