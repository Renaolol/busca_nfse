...
export class NfseController {
  ...
  @Get('leitura-fiscal')
  @ApiOkResponse({ type: NfseLeituraFiscalResponseDto })
  @TenantScope({ source: 'query', key: 'clienteId', injectWhenMissing: true })
  ...
  @Post('recuperar-por-dps')
  @TenantScope({ source: 'body', key: 'clienteId', required: true })
  recuperarPorDps(@Body() dto: RecuperarNfsePorDpsDto) {
    return this.nfseService.recuperarPorDps(dto);
  }
